...
class BusinessTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business_type" do
    assert_difference('BusinessType.count') do
      post business_types_url, params: { business_type: { category_id: @business_type.category_id, name: @business_type.name, purchase_price: @business_type.purchase_price, quantity: @business_type.quantity, sale_price: @business_type.sale_price } }
    end
  ...
  test "should update business_type" do
    patch business_type_url(@business_type), params: { business_type: { category_id: @business_type.category_id, name: @business_type.name, purchase_price: @business_type.purchase_price, quantity: @business_type.quantity, sale_price: @business_type.sale_price } }
